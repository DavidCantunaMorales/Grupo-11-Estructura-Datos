/*
    ...
    INTEGRANTES: CANTUÑA EDWIN, GUEVARA ARIEL
    PROGRAMA: MCM, MCD, SUMA DIGITOS
    FECHA DE CREACION: 23/11/2022
    FECHA DE MODIFICACION: 23/11/2022
    VERSION 1.
*/
...
int main(){
    ...
    */
    ...
    //cout << "La suma de los elementos pares es: " << lst.sumarPares() << endl;
        ...
        lsts = lsta.calcularUnidades(lst);
        lsts.mostrar();
